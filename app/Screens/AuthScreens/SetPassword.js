          ...
          <View style={styles.ContentBox}>
                ...
                >
                  ...
                  <CustomTextInput2
                    ...
                    borderColor={`${
                      ...
                      (errorFormAPI && errorFormAPI.PasswordForm)
                        ? "red"
                        : "#48484A"
                    }`}
                    errorMessage={`${
                    ...
                    rightIcon={
                      <Pressable
                        onPress={() =>
                          setShow({
                            ...setShow,
                            retypePassword: !show?.retypePassword,
                          })
                        }
                      >
                        {!show?.retypePassword ? (
            ...
            <View style={{ marginLeft: 5 }}>
              <CustomCheckBox
                ...
                content={
                  <Text>
                    I agree to the Terms and Conditions or Privacy Policy.
                  </Text>
                }
                // asterisksymbol
