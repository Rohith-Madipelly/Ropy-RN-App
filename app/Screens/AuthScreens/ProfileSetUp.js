    ...
    try {
      ...
      if (error.response) {
        ...
        if (error.response.status === 400) {
          ...
          seterrorFormAPI({
            phoneNumberForm: `${error.response.data.message}`,
          });
        ...
        <View style={styles.container}>
          <View style={styles.ContentBox}>
            <View style={{ marginLeft: 10, marginBottom: 20 }}>
              <TitleComponent
                TitleName="Profile Setup"
                style={{ color: "#001F20CC" }}
              ></TitleComponent>
            </View>
            ...
            <View style={{ alignItems: "center", flex: 0.5 }}>
              <CustomTextInput2
                ...
                borderColor={`${
                  ...
                  (errorFormAPI && errorFormAPI.firstNameForm)
                    ? "red"
                    : "#48484A"
                }`}
                errorMessage={`${
              ...
              <CustomTextInput2
                ...
                borderColor={`${
                  ...
                  (errorFormAPI && errorFormAPI.lastNameForm)
                    ? "red"
                    : "#48484A"
                }`}
                errorMessage={`${
              ...
              <CustomDateInput2
                ...
                borderColor={`${
                  ...
                  (errorFormAPI && errorFormAPI.dateOfBirthForm)
                    ? "red"
                    : "#48484A"
                }`}
                errorMessage={`${
              ...
              <CustomTextInput2
                ...
                borderColor={`${
                  ...
                  (errorFormAPI && errorFormAPI.ageForm)
                    ? "red"
                    : "#48484A"
                }`}
                errorMessage={`${
              ...
              <CustomDropdown
                ...
                borderColor={`${
                  ...
                  (errorFormAPI && errorFormAPI.genderForm)
                    ? "red"
                    : "#48484A"
                }`}
                errorMessage={`${
              ...
              <CustomDropdown
                ...
                borderColor={`${
                  ...
                  (errorFormAPI && errorFormAPI.occupationForm)
                    ? "red"
                    : "#48484A"
                }`}
                errorMessage={`${
              ...
              {values.occupation == "Other (custom entry)" ? (
                <CustomTextInput2
                  ...
                  onChangeText={(e) => {
                    handleChange("otherOccupation")(e);
                    seterrorFormAPI();
                  }}
                  ...
                  outlined
                  borderColor={`${
                    (errors.otherOccupation && touched.otherOccupation) ||
                    (errorFormAPI && errorFormAPI.otherOccupationForm)
                      ? "red"
                      : "#48484A"
                  }`}
                  errorMessage={`${
                    errors.otherOccupation && touched.otherOccupation
                      ...
                      : errorFormAPI && errorFormAPI.otherOccupationForm
                      ? `${errorFormAPI.otherOccupationForm}`
                      : ``
                  }`}
